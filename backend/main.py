...
from models.stateRequest import loadStateRequest
...
async def getProduct(data: Recommendation, profile: GiftUserProfile, uuid: str):
    return get_product(data.product, profile, uuid)
