  ...
  return (
    <div className="w-full max-w-5xl">
      <div className="bg-white p-8 rounded-3xl shadow-md mb-8">
        <h2 className="text-3xl font-bold text-[#e77ed6] mb-6 text-center">Research Page</h2>
        <p className="text-lg text-gray-700 mb-8 text-center">
          This is a placeholder for the research page where users will see research results.
        </p>
